...
export function SchematicGrid({ variant = 0 }: { variant?: number }) {
  ...
  return (
    <svg ref={root} viewBox="0 0 640 420" className="h-full w-full" aria-hidden>
      <rect width="640" height="420" fill="var(--black)" />
      <g stroke="var(--white)" strokeOpacity="0.1" strokeWidth="1">
      ...
      <g fill="none" stroke="var(--yellow)" strokeWidth="1.3">
      ...
      <circle className="g-node" cx="260" cy="80" r="4" fill="var(--yellow)" />
      <circle className="g-node" cx="500" cy="240" r="4" fill="var(--yellow)" />
      <circle className="g-node" cx="260" cy="300" r="4" fill="var(--yellow)" />
    </svg>
  );
}
